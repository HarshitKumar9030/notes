...
export default function Navbar() {
    ...
    <>
     <div className="h-20 p-8 text-white flex justify-between items-center">
        ...
        <div className="button px-4 py-2 hover:shadow-xl shadow-zinc-700 text-white bg-zinc-800 text-xl font-medium hover:bg-zinc-700 duration-200 hover:scale-105 selection:bg-transparent cursor-ne-resize rounded-md">Add New</div>
     </div>
